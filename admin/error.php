...
<html lang="en" style="height: 100%">
  <head>
    ...
    <title>Umega App - 404 Not Found</title>
    <!-- PACE-->
  ...
  <body style="background-image: url(../build/images/backgrounds/16.jpg)" class="body-bg-full">
    <div class="container page-container">
      <div class="page-content">
        ...
        <h1 style="font-size: 130px" class="m-0 text-muted fw-300">4<i class="ti-face-sad fs-100"></i>4</h1>
        <h4 class="fs-16 text-white fw-300">Page Not Found!</h4>
        <p class="text-muted mb-15">Sorry! the page you are looking for doesn't exist.</p><a href="index-2.html" role="button" style="width: 130px" class="btn btn-primary btn-rounded">Return home</a>
      </div>
    </div>
    <!-- Demo Settings start-->
    ...
    <!-- Custom JS-->
    <script type="text/javascript" src="../build/js/third-layout/extra-demo.js"></script>
  </body>
</html>